...
$builds = @(
  @{port=7000; name='course_monitor'; version='0.4.0'; app='course-collector'; extra=@('--add-data', ((Join-Path $Project 'p7000\ui.html') + ';.'),'--hidden-import','tkinter')},
  @{port=7050; name='touchpad_gateway'; version='0.3.2'; app='claude-code-gateway-touchpad'; extra=@('--add-data', ((Join-Path $Project 'p7050\ui.html') + ';.'))},
